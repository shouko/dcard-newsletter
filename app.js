...
var mail_head = '<table bgcolor="#FAFAFA" border="0" cellspacing="0" cellpadding="0" style="width: 100%; padding-top: 30px; text-align:middle"><tbody><tr><td><center><img src="https://shouko.github.io/dcard-newsletter/img/logo.png"><br>';
mail_head += '<h2>狄卡精選</h2><h3>成為大學生的第一步</h3></center></td></tr>';
var mail_body = '';
var mail_foot = '<tr><td><center>\
	...
	<br><br>\
	<span style="color:#797979">不想再收到 Dcard 電子報? <a style="color:#595959" href="">取消訂閱</a></span>\
</center></td></tr>\
</tbody></table>';
var to = [];
...
posts.forEach(function(post) {
	mail_body += '<tr><td>\
	<a href="https://www.dcard.tw/f/all/p/63823"><table border="0" cellspacing="0" cellpadding="10" style="width: 90%;margin: 0 auto;table-layout: fixed;max-width: 800px"><tbody style="box-shadow: 3px black">\
		...
		<tr bgcolor="white"><td colspan="9" style="padding-left:2vw"><h2>' + post.title + '</h2></td><td colspan="3" style="color:#F57A7A"><center><img src="https://shouko.github.io/dcard-newsletter/img/heart.png">' + post.likes + '</center></td></tr>\
		<tr bgcolor="white" style="color:#797979;white-space: pre"><td colspan="12" style="padding-left:2vw">' + post.content + '<br><br></td></tr>';
